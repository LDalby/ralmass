...
ConvertParam <- function(param = NULL) {
	...
	switch(EXPR = param,
  	# Names of the paramters:
		...
		"GOOSE_STARTNO_SCALER" = "Goose input number scaler",
		"GOOSE_PF_STARTNO_SCALER" = "Pinkfoot input number scaler",
		"GOOSE_BN_STARTNO_SCALER" = "Barnacle input number scaler",
		"GOOSE_GL_STARTNO_SCALER" = "Greylag input number scaler",
