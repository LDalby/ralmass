...
GetParamType <- function(param) {
  ...
  switch(
    ...
    "GOOSE_STARTNO_SCALER" = "GOOSE_STARTNO_SCALER (float)",
    "GOOSE_PF_STARTNO_SCALER" = "GOOSE_PF_STARTNO_SCALER (float)",
    "GOOSE_BN_STARTNO_SCALER" = "GOOSE_BN_STARTNO_SCALER (float)",
    "GOOSE_GL_STARTNO_SCALER" = "GOOSE_GL_STARTNO_SCALER (float)",
    "PETTIFOR_C_BN" = "PETTIFOR_C_BN (float)",
    "PETTIFOR_A_BN" = "PETTIFOR_A_BN (float)",
